...
const INIT={nom:null,valeurs:[],facetteId:null,identite:null,xp:0,totalVotes:0,histoire:{},facettesState:{},votesJour:{},customVotes:{},sommeilJour:false,energieJour:0,aureleJour:null,aureleAnswer:null,bossJour:false,lastDay:null,lastWeek:null,usedAureles:[],feedbacks:[],kryosDaily:null,kryosDailyDate:null};
...
export default function App() {
  ...
  const TABS=[{id:"facette",label:"FACETTE",icon:f?.icon||"◈"},{id:"votes",label:"VOTES",icon:"⚔"},{id:"profil",label:"PROFIL",icon:"◎"},{id:"quetes",label:"QUÊTES",icon:"✦"},{id:"retour",label:"RETOUR",icon:"◇"}];
